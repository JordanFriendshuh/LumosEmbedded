...
size_t xTotalHeapSize = configTOTAL_HEAP_SIZE;
	...
	ulAddress = ( unsigned int ) ucHeap;

	if( ( ulAddress & portBYTE_ALIGNMENT_MASK ) != 0 )
	{
		ulAddress += ( portBYTE_ALIGNMENT - 1 );
		ulAddress &= ~portBYTE_ALIGNMENT_MASK;
		xTotalHeapSize -= ulAddress - ( unsigned int ) ucHeap;
	}
	...
	ulAddress = ( ( unsigned int ) pucAlignedHeap ) + xTotalHeapSize;
	...
	pxFirstFreeBlock->xBlockSize = ulAddress - ( unsigned int ) pxFirstFreeBlock;
